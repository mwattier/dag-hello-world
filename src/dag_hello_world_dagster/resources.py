"""
Custom IO Manager for Dag Hello World module.
...
class DagHelloWorldIOManager(ConfigurableIOManager):
    """
    Custom IO Manager for Dag Hello World assets.
    ...
    def _get_path(self, context) -> str:
        ...
        # Get the asset key path (e.g., ["dag_hello_world", "my_asset"])
...
@io_manager
def dag_hello_world_io_manager() -> DagHelloWorldIOManager:
    """IO Manager factory for Dag Hello World assets."""
    storage_path = os.environ.get('DAGSTER_STORAGE_PATH', '/tmp/dagster_storage')
    return DagHelloWorldIOManager(base_path=storage_path)
